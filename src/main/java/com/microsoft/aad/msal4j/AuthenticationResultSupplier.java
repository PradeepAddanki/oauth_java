...
abstract class AuthenticationResultSupplier implements Supplier<IAuthenticationResult> {
    ...
    public IAuthenticationResult get() {
        ...
        try (TelemetryHelper telemetryHelper =
            ...
            try {
                ...
                if (ex instanceof VasaraCloudException) {
                    VasaraCloudException exception = ((VasaraCloudException) ex);
                    if (exception.getErrorCode() != null) {
                        apiEvent.setApiErrorCode(exception.getErrorCode());
                    }
                } else {
                    if (ex.getCause() != null) {
    ...
    private void logException(Exception ex) {
        ...
        if (ex instanceof VasaraCloudException) {
            VasaraCloudException exception = (VasaraCloudException) ex;
            if (exception.getErrorCode() != null && exception.getErrorCode().equalsIgnoreCase(AuthenticationErrorCode.CACHE_MISS)) {
