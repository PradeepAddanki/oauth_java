...
class TokenResponse extends OIDCTokenResponse {
    ...
    static TokenResponse parseJsonObject(final JSONObject jsonObject)
        ...
        try {
            ...
            throw new VasaraCloudException("Invalid or missing token, could not parse. If using B2C, information on a potential B2C issue and workaround can be found here: https://aka.ms/msal4j-b2c-known-issues",
